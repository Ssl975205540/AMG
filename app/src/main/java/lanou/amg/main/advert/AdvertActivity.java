...
private TextView WelComeActivity_TextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences sharedPreferences = getSharedPreferences("adaverActivity",MODE_PRIVATE);
        SharedPreferences.Editor sharedPreferences_edit = sharedPreferences.edit();
        sharedPreferences_edit.commit();
        Boolean ds = sharedPreferences.getBoolean("first",true);
        ...
        if(ds){
            ...
            execute = true;
            SharedPreferences sharedPreferences1 = getSharedPreferences("adaverActivity",MODE_PRIVATE);
            SharedPreferences.Editor savedInstanceState_edit = sharedPreferences1.edit();
            savedInstanceState_edit.putBoolean("first",false);
